...
_G.packer_plugins = {
  ["Comment.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "${HOME}/.local/share/nvim/site/pack/packer/opt/Comment.nvim",
  ...
  LuaSnip = {
    ...
    loaded = false,
    needs_bufread = true,
    path = "${HOME}/.local/share/nvim/site/pack/packer/opt/LuaSnip",
  ...
  base46 = {
    ...
    loaded = true,
    only_config = true,
    path = "${HOME}/.local/share/nvim/site/pack/packer/start/base46",
    url = "https://github.com/NvChad/base46"
  },
  ["cmp-buffer"] = {
    after = { "cmp-path" },
    after_files = { "${HOME}/.local/share/nvim/site/pack/packer/opt/cmp-buffer/after/plugin/cmp_buffer.lua" },
    load_after = {
      ["cmp-nvim-lsp"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "${HOME}/.local/share/nvim/site/pack/packer/opt/cmp-buffer",
    url = "https://github.com/hrsh7th/cmp-buffer"
  },
  ["cmp-nvim-lsp"] = {
    after = { "cmp-buffer" },
    after_files = { "${HOME}/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lsp/after/plugin/cmp_nvim_lsp.lua" },
    load_after = {
      ["cmp-nvim-lua"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "${HOME}/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lsp",
    url = "https://github.com/hrsh7th/cmp-nvim-lsp"
  },
  ["cmp-nvim-lua"] = {
    after = { "cmp-nvim-lsp" },
    after_files = { "${HOME}/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lua/after/plugin/cmp_nvim_lua.lua" },
    load_after = {
      cmp_luasnip = true
    },
    loaded = false,
    needs_bufread = false,
    path = "${HOME}/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lua",
    url = "https://github.com/hrsh7th/cmp-nvim-lua"
  },
  ["cmp-path"] = {
    after_files = { "${HOME}/.local/share/nvim/site/pack/packer/opt/cmp-path/after/plugin/cmp_path.lua" },
    load_after = {
      ["cmp-buffer"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "${HOME}/.local/share/nvim/site/pack/packer/opt/cmp-path",
    url = "https://github.com/hrsh7th/cmp-path"
  },
  cmp_luasnip = {
    after = { "cmp-nvim-lua" },
    after_files = { "${HOME}/.local/share/nvim/site/pack/packer/opt/cmp_luasnip/after/plugin/cmp_luasnip.lua" },
    load_after = {
      LuaSnip = true
    },
    loaded = false,
    needs_bufread = false,
    path = "${HOME}/.local/share/nvim/site/pack/packer/opt/cmp_luasnip",
  ...
  extensions = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "${HOME}/.local/share/nvim/site/pack/packer/opt/extensions",
  ...
  ["friendly-snippets"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "${HOME}/.local/share/nvim/site/pack/packer/opt/friendly-snippets",
  ...
  ["gitsigns.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "${HOME}/.local/share/nvim/site/pack/packer/opt/gitsigns.nvim",
    url = "https://github.com/lewis6991/gitsigns.nvim"
  },
  ["impatient.nvim"] = {
    loaded = true,
    path = "${HOME}/.local/share/nvim/site/pack/packer/start/impatient.nvim",
  ...
  ["mason.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "${HOME}/.local/share/nvim/site/pack/packer/opt/mason.nvim",
  ...
  ["nvim-cmp"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "${HOME}/.local/share/nvim/site/pack/packer/opt/nvim-cmp",
  ...
  ["nvim-colorizer.lua"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "${HOME}/.local/share/nvim/site/pack/packer/opt/nvim-colorizer.lua",
  ...
  ["nvim-lspconfig"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "${HOME}/.local/share/nvim/site/pack/packer/opt/nvim-lspconfig",
  ...
  ["nvim-tree.lua"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "${HOME}/.local/share/nvim/site/pack/packer/opt/nvim-tree.lua",
  ...
  ["nvim-treesitter"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "${HOME}/.local/share/nvim/site/pack/packer/opt/nvim-treesitter",
  ...
  ["nvim-web-devicons"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "${HOME}/.local/share/nvim/site/pack/packer/opt/nvim-web-devicons",
  ...
  nvterm = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "${HOME}/.local/share/nvim/site/pack/packer/opt/nvterm",
  ...
  ["packer.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "${HOME}/.local/share/nvim/site/pack/packer/opt/packer.nvim",
  ...
  ["plenary.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "${HOME}/.local/share/nvim/site/pack/packer/opt/plenary.nvim",
  ...
  ["telescope.nvim"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "${HOME}/.local/share/nvim/site/pack/packer/opt/telescope.nvim",
  ...
  ui = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "${HOME}/.local/share/nvim/site/pack/packer/opt/ui",
    url = "https://github.com/NvChad/ui"
  },
  ["vim-better-whitespace"] = {
    loaded = true,
    path = "${HOME}/.local/share/nvim/site/pack/packer/start/vim-better-whitespace",
  ...
  ["which-key.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "${HOME}/.local/share/nvim/site/pack/packer/opt/which-key.nvim",
